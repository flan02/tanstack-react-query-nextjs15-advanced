...
import { ButtonFetch } from "@/components/custom/ButtonFetch";
...
export default function FundamentalsPage() {
  const [category, setCategory] = useState<ButtonTypes>('technology');

  return (
    <div className="max-w-4xl mx-auto p-6 min-h-[80vh]">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-4">Basic React Query</h1>
        <p className="mb-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex space-x-2 mb-4">
          {
            ButtonTypes.map((type: ButtonTypes, index: number) => (
              <ButtonFetch key={index} category={type} setCategory={setCategory} />
            ))
          }
        </div>

        <div className="border rounded-lg overflow-hidden shadow-sm">
          <div className="bg-orange-100 p-3 font-medium border-b">
            React Query
          </div>
